...
<head>
    ...
    <title>Register Mini Library Smart City</title>
...
<body>
    <div class="container d-flex flex-column justify-content-center align-items-center min-vh-100">
        <div class="card smartcity-card">
            ...
            <div class="login-title">Register Mini Library</div>
            @if (session('error'))
            ...
            @endif
            <form method="POST" action="/register" class="custom-login-form">
                @csrf
                ...
                <input type="number" name="nim" class="custom-input" placeholder="Nim" required>
            ...
            <div class="mt-3 text-center">
                <a href="/login" class="custom-link">Already have an account? Login here</a>
            </div>
        </div>
    </div>
